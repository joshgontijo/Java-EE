...
public class CustomPartitionAnalyzer implements PartitionAnalyzer {
    ...
    public void analyzeCollectorData(Serializable data) throws Exception {
        logger.log(Level.INFO, ":: analyzeCollectorData= {0} ::", data.toString());
    }

    @Override
    public void analyzeStatus(BatchStatus batchStatus, String exitStatus) throws Exception {
        logger.log(Level.INFO, ":: analyzeStatus STATUS={0} EXITSTATUS={1}::", new Object[]{batchStatus.name(), exitStatus});
    }
