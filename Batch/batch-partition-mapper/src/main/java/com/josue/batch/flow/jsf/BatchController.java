...
//        logger.info("LOADING...");
        try {
            jobInstances = BatchRuntime.getJobOperator().getJobInstances("mapped-partition-job", 0, 100);
        } catch (Exception e) {
            return;
        }
    ...
    public void startJob() {
        long execId = BatchRuntime.getJobOperator().start("simple-partition-mapped", null);
